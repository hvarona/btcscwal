 ...
 */
public class SteemTransactionBroadcastSequence extends WebSocketAdapter {
     ...
     */
    public SteemTransactionBroadcastSequence(Transaction transaction, WitnessResponseListener listener){
    ...
    public void onTextFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        if(frame.isTextFrame())
            System.out.println(TAG + "<<< "+frame.getPayloadText());
    ...
    public void onError(WebSocket websocket, WebSocketException cause) throws Exception {
        System.err.println(TAG + "onError. cause: "+cause.getMessage());
    ...
    public void handleCallbackError(WebSocket websocket, Throwable cause) throws Exception {
        System.err.println(TAG + "handleCallbackError. cause: "+cause.getMessage()+", error: "+cause.getClass());
        for (StackTraceElement element : cause.getStackTrace()){
            System.err.println(TAG + element.getFileName()+"#"+element.getClassName()+":"+element.getLineNumber());
        }
        mListener.onError(new BaseResponse.Error(cause.getMessage()));
        websocket.disconnect();
    }
