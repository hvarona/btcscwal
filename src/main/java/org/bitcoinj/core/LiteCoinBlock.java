...
public class LiteCoinBlock extends Block{
    ...
    LiteCoinBlock(NetworkParameters params, long setVersion) {
     ...
     */
    @Deprecated
    public LiteCoinBlock(NetworkParameters params, byte[] payloadBytes) throws ProtocolException {
     ...
     */
    public LiteCoinBlock(NetworkParameters params, byte[] payloadBytes, MessageSerializer serializer, int length)
            throws ProtocolException {
     ...
     * @throws ProtocolException
     */
    public LiteCoinBlock(NetworkParameters params, byte[] payloadBytes, int offset, MessageSerializer serializer, int length)
            throws ProtocolException {
     ...
     * @throws ProtocolException
     */
    public LiteCoinBlock(NetworkParameters params, byte[] payloadBytes, int offset, @Nullable Message parent, MessageSerializer serializer, int length)
            throws ProtocolException {
     ...
     */
    public LiteCoinBlock(NetworkParameters params, long version, Sha256Hash prevBlockHash, Sha256Hash merkleRoot, long time,
