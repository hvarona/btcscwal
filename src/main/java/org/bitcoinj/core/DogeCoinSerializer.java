 ...
 *
 */
public class DogeCoinSerializer extends BitcoinSerializer {
    
    private static final Logger log = LoggerFactory.getLogger(DogeCoinSerializer.class);
     ...
     */
    public DogeCoinSerializer(NetworkParameters params, boolean parseRetain) {
