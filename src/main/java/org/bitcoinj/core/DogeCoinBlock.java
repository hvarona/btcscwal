...
import de.bitsharesmunich.cryptocoincore.base.dash.X11;
...
public class DogeCoinBlock extends Block{
    ...
    DogeCoinBlock(NetworkParameters params, long setVersion) {
     ...
     */
    @Deprecated
    public DogeCoinBlock(NetworkParameters params, byte[] payloadBytes) throws ProtocolException {
     ...
     */
    public DogeCoinBlock(NetworkParameters params, byte[] payloadBytes, MessageSerializer serializer, int length)
            throws ProtocolException {
     ...
     * @throws ProtocolException
     */
    public DogeCoinBlock(NetworkParameters params, byte[] payloadBytes, int offset, MessageSerializer serializer, int length)
            throws ProtocolException {
     ...
     * @throws ProtocolException
     */
    public DogeCoinBlock(NetworkParameters params, byte[] payloadBytes, int offset, @Nullable Message parent, MessageSerializer serializer, int length)
            throws ProtocolException {
     ...
     */
    public DogeCoinBlock(NetworkParameters params, long version, Sha256Hash prevBlockHash, Sha256Hash merkleRoot, long time,
